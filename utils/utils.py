...
def plot_one_box(x, img, color=None, label=None, line_thickness=None):
    ...
    if label:
        ...
        # font = ImageFont.truetype("/usr/share/fonts/truetype/nanum/NanumBarunGothicBold.ttf", 10)
        # img_pil = Image.fromarray(img)
        # draw = ImageDraw.Draw(img_pil)
        # # draw.text((c1[0], c1[1] - 2), label, font=font, fill='white')
        # draw.text((c1[0], c1[1]-3), label, font=font, fill=(255, 255, 255, 0))
        # print(c1)
        # print("------")
        # print(c2)
